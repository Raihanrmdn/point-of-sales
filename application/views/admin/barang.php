...
<div class="container-fluid">
    ...
    <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#tambahBarangModal"><i class="fa fa-plus"></i> Tambah Barang</a>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($barang as $b) : ?>
                            <tr>
                                ...
                                <td class="text-right"><?= indo_currency($b['harga_beli']); ?></td>
                                <td class="text-right"><?= indo_currency($b['harga_jual']); ?><S /td>
                                <td align="center">
